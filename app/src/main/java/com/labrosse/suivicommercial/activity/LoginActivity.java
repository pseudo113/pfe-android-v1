...
public class LoginActivity extends AppCompatActivity {
    ...
    private void getUsers() {
        ...
        ArrayList<AdUser> getUSers = AdUserDAO.getInstance(this).getUsers();

        if(getUSers == null || getUSers.isEmpty()){
            String jsonString =  loadJSONFromAsset();
            Gson gson = new GsonBuilder().create();
            AdUserResponse r = gson.fromJson(jsonString, AdUserResponse.class);

            ArrayList<AdUser> users = null;
            if( r != null && !r.getUsers().isEmpty()){
                users = r.getUsers();

                for(AdUser user : users){
                    long l = AdUserDAO.getInstance(this).addUser(user);
                }
            }
        }
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            AdUser user =  AdUserDAO.getInstance(LoginActivity.this).getUser(mEmail, mPassword);

            if(user != null){
               boolean updated = AdUserDAO.getInstance(LoginActivity.this).setUserActive(user);
               return updated;
            }
